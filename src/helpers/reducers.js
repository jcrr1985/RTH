...
export const initState_requestForm = {
  ...
  showTooltip: "You must select any specialization first",
  countries: [], countryProps: [],
  date: dayjs('2014-08-18T21:11:54'), ciudades: [],
  selectedCountry: '',
  clinicsToDisplay: [],
  availableCLinicsPayload: { country: '', city: '' },
  payloadCountry: '',
  currentCityprops: [], allCitiesProps: [],
  clinicasInSelectedCountry: [],
  showMap: false,
  latLng: { lat: 0, lng: 0 }
}
