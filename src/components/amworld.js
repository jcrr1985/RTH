...
export default function amWorld(setCountryInAmworld) {
  ...
  polygonSeries.mapPolygons.template.on("active", function (active, target) {
    console.log('target.dataItem.dataContext.name', target.dataItem.dataContext.name);
    setCountryInAmworld(target.dataItem.dataContext.name);
    const selectedCountry = target.dataItem.dataContext.name;
